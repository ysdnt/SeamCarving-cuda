...
{	
	...
	writePnm(correctOutPixels, width, height, concatStr(outFileNameBase, "_ck1_gray_host.pnm"));
	...
	writePnm(correctOutSobelPixels, width, height, concatStr(outFileNameBase, "_ck1_sobel_host.pnm"));
	...
	writePnm(inPixels, i, height, concatStr(outFileNameBase, "_ck1_seam_host.pnm"));
